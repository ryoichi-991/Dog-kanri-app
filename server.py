...
def layout(title: str, body: str, user: User | None = None) -> str:
    ...
    if user:
        ...
        <a class="brand" href="/dashboard"><span class="brand-mark">E</span><span><strong>ESTRELLA</strong><small>Breeder Management</small></span></a>
        <nav>
...
.guest main{{max-width:760px;margin:45px auto;padding:24px}}
